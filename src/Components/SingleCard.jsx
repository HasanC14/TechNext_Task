const SingleCard = ({ user }) => {
  return (
    <div className=" rounded-lg shadow-md p-6 bg_glass custom-border flex justify-center items-center  lg:flex-row lg:space-x-10 space-x-0 flex-col hover:scale-105 transition-all ease-in-out duration-700 text-center lg:text-left">
